(function() {
  ...
  window.S3Upload = (function() {
	...
	S3Upload.prototype.file_dom_selector = 'input[type=file]';
	...
	S3Upload.prototype.handleFileSelect = function(file_element) {
	  ...
	  S3Upload.prototype.s3_object_name = (new Date().getTime()) + jQuery(this.file_dom_selector).get(0).value.replace(/C:\\fakepath\\/i, '');
